...
const movieImageController = async (req, res) => {
    try {
        ...
        const updatedMovieImageUrl = "https://api.themoviedb.org/3/movie/movie_id/images?api_key=".replace("movie_id", movieId.toString());
...
const tvImageController = async (req, res) => {
    try {
        ...
        // replacing id & fetching data 
        const updatedTvImageUrl =  "https://api.themoviedb.org/3/movie/series_id/images?api_key=".replace("series_id", seriesId.toString());
