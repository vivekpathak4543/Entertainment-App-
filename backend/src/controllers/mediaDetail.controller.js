...
const movieDetailController = async (req, res) => {
    try {
        ...
        // url editing 
        const updatedMovieDetailUrl = "https://api.themoviedb.org/3/movie/movie_id?append_to_response=20&language=en-US".replace("movie_id", movieId.toString());
        const updatedCastMovieUrl = "https://api.themoviedb.org/3/movie/movie_id/credits?language=en-US".replace("movie_id", movieId.toString());
...
const tvDetailController = async (req, res) => {
    try {
        ...
        // url editing 
        const updatedTvDetailUrl = "https://api.themoviedb.org/3/tv/series_id?append_to_response=20&language=en-US".replace("series_id", seriesId.toString());
        const updatedCastTvUrl = "https://api.themoviedb.org/3/tv/series_id/credits?language=en-US".replace("series_id", seriesId.toString());
